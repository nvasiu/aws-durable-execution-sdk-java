...
/**
 * Utility class for throwing checked exceptions as unchecked exceptions using type erasure. This allows us to rethrow
 * exceptions without wrapping them in RuntimeException.
 */
